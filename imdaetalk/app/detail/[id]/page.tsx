...
export default async function DetailPage({ params }: PageProps) {
  ...
  return (
    <div className="pb-24">
      {/* 🚀 Hero 섹션 */}
      <div className="px-5 pt-8 pb-10 bg-slate-50">
        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#00D09E]/10 text-[#00D09E] text-[12px] font-extrabold tracking-tight mb-4">
          <TrendingUp className="h-3.5 w-3.5" />
          가치 성장 리포트
        </div>
        
        <h1 className="text-[22px] font-bold text-slate-800 leading-tight mb-3">
          이 공고에 당첨되면<br />
          10년 뒤 이렇게 될 거예요 ✨
        </h1>
      ...
      <div className="px-4 space-y-4 -mt-4 relative z-10">
        ...
        {/* 📋 내 조건/가점 체크 벤토 박스 (로그인 여부에 따라 분기) */}
        <BentoBox>
      ...
      {/* 하단 고정 액션 바 */}
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md z-40 px-4 pb-6 pt-4 bg-white/90 backdrop-blur-xl border-t border-slate-100 safe-bottom">
